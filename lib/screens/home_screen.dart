...
import 'package:loco/screens/pressed_category.dart';
                                      ...
                                      itemBuilder: (context, index) => Row(
                                        children: [
                                          ...
                                          OutlineGradientButton(
                                            ...
                                            child: Text('${item[index]!.categName}',style: TextStyle(
                                              fontSize: 12.sp,
                                            ),),
                                            ...
                                            onTap: (){
                                              ...
                                              Get.to(PressedScreen(CatName: '${item[index]!.categName}',));},
                                            gradient: LinearGradient(colors: [  Color(0xffffa36c),  Styles.defualtColor,]),
                                            strokeWidth: 1,
